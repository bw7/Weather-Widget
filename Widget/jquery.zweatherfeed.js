...
(function($){
	...
	$.fn.weatherfeed = function(locations, options, fn) {	
		...
		return this.each(function(i, e) {
			...
			var api = 'http://query.yahooapis.com/v1/public/yql?q=select%20item%20from%20weather.forec ast%20where%20location%3D%2222102%22&format=json'+ encodeURIComponent(query) +'&rnd='+ now.getFullYear() + now.getMonth() + now.getDay() + now.getHours() +'&format=json&callback=?';
